                      ...
                      <div className="flex items-center gap-3.5">
                        ...
                        <div className="space-y-0.5 min-w-0">
                          <div className="flex items-center gap-2 flex-wrap">
                            ...
                            {isPersonal ? (
                              <span className="text-[10px] font-bold px-2 py-0.5 rounded-full border border-blue-200 bg-blue-50 text-blue-700 tracking-wide uppercase">
                                Personal
                              </span>
                            ) : (
                              <span className="text-[10px] font-bold px-2 py-0.5 rounded-full border border-amber-200 bg-amber-50/80 text-amber-800 tracking-wide uppercase">
                                Business
                              </span>
                            )}
                          </div>
                    ...
                    {primaryContact ? (
                      <div className="space-y-0.5">
                        <div className="font-bold text-slate-800 flex items-center gap-1.5">
                          ...
                          <span className="text-[10px] font-bold px-1.5 py-0.2 rounded border border-amber-200 bg-amber-50 text-amber-800 tracking-wide uppercase">
                            Primary
                          </span>
                        </div>
                      ...
                      {isEditing ? (
                        <>
                          <button
                            ...
                            title="Save Changes"
                            className="p-2 rounded-xl bg-emerald-50 hover:bg-emerald-100 text-emerald-600 transition-all cursor-pointer border border-emerald-200/60 shadow-2xs hover:scale-105"
                          >
                          ...
                          <button
                            ...
                            title="Cancel"
                            className="p-2 rounded-xl bg-slate-100 hover:bg-slate-200 text-slate-600 transition-all cursor-pointer border border-slate-200/60 shadow-2xs hover:scale-105"
                          >
                            <X className="w-4 h-4" />
                          </button>
                        </>
