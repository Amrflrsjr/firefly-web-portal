    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-900/50 backdrop-blur-xs p-4 overflow-y-auto">
      <div className="bg-white rounded-3xl shadow-2xl border border-slate-100 w-full max-w-lg overflow-hidden my-8 flex flex-col max-h-[90vh] animate-in fade-in zoom-in-95 duration-200">
        ...
        <form
          ...
          className="p-6 overflow-y-auto space-y-4 flex-1 bg-slate-50/50"
        >
          ...
          <div className="flex items-center gap-2.5 bg-white p-3.5 rounded-2xl border border-slate-200/80 shadow-2xs">
            <input
              type="checkbox"
              id="editIsPrimary"
              ...
              className="w-4 h-4 rounded border-slate-300 text-[#F9B53F] focus:ring-[#F9B53F] accent-[#F9B53F] cursor-pointer"
            />
            <label
              htmlFor="editIsPrimary"
              className="text-xs font-extrabold text-slate-700 select-none cursor-pointer"
            >
