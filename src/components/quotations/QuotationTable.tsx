              ...
              return (
                ...
                >
                  ...
                  <td className="py-3.5 px-4">
                    ...
                    <div className="text-[11px] text-slate-500 dark:text-slate-400 font-normal mt-0.5 flex items-center gap-1.5">
                      ...
                      {isMenuOpen && menuCoords && (
                        ...
                        >
                          ...
                          {isEditable ? (
                            ...
                            <button
                              disabled
                              className="w-full px-3.5 py-2 text-slate-300 dark:text-slate-600 flex items-center gap-2 cursor-not-allowed"
                            >
