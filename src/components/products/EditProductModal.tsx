        ...
        >
          <div className="p-6 space-y-6 overflow-y-auto flex-1 bg-slate-50/50 dark:bg-slate-950/40">
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center gap-3.5 p-4 bg-white dark:bg-slate-900 border border-slate-200/80 dark:border-slate-800 rounded-2xl shadow-2xs">
                <input
                  type="checkbox"
                ...
                <label
                  ...
                  className="text-xs font-bold text-slate-700 dark:text-slate-300 cursor-pointer select-none flex-1"
                >
                  Active in Catalog
