...
export const Profile: React.FC = () => {
  ...
  // Check if current form inputs differ from saved profile data
  ...
  return (
    <div className="space-y-6 sm:space-y-8 pb-10 px-4 sm:px-0 animate-in fade-in duration-300">
      ...
      <div className="relative overflow-hidden bg-linear-to-r from-slate-900 via-slate-800 to-slate-900 rounded-3xl p-6 sm:p-8 text-white shadow-2xl transition-all duration-300 hover:shadow-slate-900/20">
        ...
        <div className="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-6">
          <div className="space-y-2">
            <div className="flex flex-wrap items-center gap-2">
              <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-white/10 backdrop-blur-md border border-white/10 text-amber-300 text-xs font-bold transition-transform hover:scale-105">
      ...
      <div className="bg-white border border-slate-100 rounded-3xl p-6 sm:p-8 shadow-xl shadow-slate-100/60 space-y-6 transition-all duration-300 hover:shadow-2xl">
        <div className="flex items-center gap-3 pb-4 border-b border-slate-100">
          <div className="w-10 h-10 rounded-2xl bg-amber-50 border border-amber-200/60 flex items-center justify-center text-amber-600 shadow-2xs transition-transform hover:rotate-6">
        ...
        <form onSubmit={handleUpdateProfile} className="space-y-6">
          <div className="flex flex-col lg:flex-row gap-8 items-start">
            ...
            <div className="flex-1 w-full space-y-4">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full bg-slate-50/80 border border-slate-200 rounded-xl px-3.5 py-2 text-xs font-semibold text-slate-800 focus:outline-none focus:border-[#F9B53F] focus:bg-white focus:ring-4 focus:ring-[#FFCB62]/15 transition-all shadow-2xs"
                />
              </div>
            ...
            {/* Right Side Avatar Circle Card */}
            <div className="w-full lg:w-72 flex flex-col items-center justify-center p-6 bg-slate-50/80 border border-slate-200/80 rounded-3xl shrink-0 self-center lg:self-start transition-transform hover:scale-[1.02]">
              <div className="w-28 h-28 rounded-full bg-linear-to-br from-slate-900 to-slate-800 text-amber-300 font-black text-2xl flex items-center justify-center border-4 border-white shadow-xl overflow-hidden transition-transform hover:rotate-3">
            ...
            <div className="overflow-hidden">
              <div className="flex items-center justify-end gap-3">
                <button
                  ...
                  className="inline-flex items-center gap-1.5 px-4 py-2.5 rounded-xl border border-slate-200 text-slate-600 font-bold text-xs hover:bg-slate-50 active:scale-98 transition-all cursor-pointer shadow-2xs"
                >
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pb-4 border-b border-slate-100">
          ...
          {!showPasswordSection && (
            <button
              ...
              className="inline-flex items-center gap-2 px-4 py-2 rounded-xl bg-slate-100 hover:bg-slate-200 text-slate-700 text-xs font-bold transition-all active:scale-98 cursor-pointer shadow-2xs self-start sm:self-auto"
            >
            ...
            <form onSubmit={handleResetPassword} className="space-y-5 pt-2">
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      placeholder="••••••••"
                      className="w-full bg-slate-50/80 border border-slate-200 rounded-xl pl-11 pr-4 py-3 text-sm font-semibold text-slate-800 focus:outline-none focus:border-[#F9B53F] focus:bg-white focus:ring-4 focus:ring-[#FFCB62]/15 transition-all shadow-2xs"
                    />
                  </div>
                </div>
              ...
              <div className="flex items-center justify-end gap-3 pt-4 border-t border-slate-100">
                <button
                  ...
                  className="px-5 py-3 rounded-xl border border-slate-200 text-slate-600 font-bold text-xs hover:bg-slate-50 active:scale-98 transition-all cursor-pointer"
                >
                  Cancel
                </button>
                <button
